...
export default function Contact() {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm('gmail', 'template_71xyb1h', e.target, 'user_UbO2fdiEpLffF0OdcXUY3')
      .then((result) => {
    ...
    <div className="contact">
        ...
        <div className="contact__formLeft">
            <form className="contact__form" onSubmit={sendEmail}>
                <h1><span>drop</span> us a line...</h1>
                ...
                <div className="contact__formItem">
                    ...
                    <input type="text" name="user_business" placeholder="Your business..." required/>
                </div>
                <div className="contact__formItem">
                    <label>Phone</label>
