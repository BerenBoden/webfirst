...
const Services = (props) => {
  return (
    <div className="services">
      ...
      <div className="line-box-bottom"></div>
      <div className="services__body2">
        ...
        <div className="services__bodyRight">
          ...
          <p>
            Although there's a lot of hype around WordPress and over 33% of all
            the world's websites run on WordPress, this however can create a lot
            of unoriginality and may make you website look a little bland. So to
            combat this, I can create a fully customized authentic website for
            you, built from the ground up with nothing but the MERN stack, this
            is generally front-end work only, meaning it's better to keep this
      ...
      <div className="services__bodyChecks">
        ...
        <div className="cards__container">
          <div className="cards__containerInner1">
            ...
            <p>
              Google changes it's search alogrithm standards every so often,
              changing what is important to rank. And web accessibility
              guidelines for users with screen readers get updated as well. So
              we also include lifetime updates to your website to make sure it
              never goes out of date and is always changing with the times.
            </p>
          </div>
